...
const Hero = () => {
  ...
  const badges = [
    { icon: Bot, text: "Solutions IA sur mesure", color: "from-pink-500 to-red-500" },
    { icon: Workflow, text: "Automatisation des processus", color: "from-blue-500 to-purple-500" },
    { icon: BarChart2, text: "Impact opérationnel mesurable", color: "from-green-500 to-teal-500" },
  ];
          ...
          >
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl tracking-wider mb-4 relative z-10">
                ...
                <span className="font-spiritual font-light">
                  Spirit Bird
                </span>{' '}

                <span className="text-gradient-animate font-spiritual">
                  IA Solutions
                </span>
            ...
            >
              ...
              J'intègre des solutions IA à vos outils existants pour automatiser vos processus métiers,
              réduire les tâches répétitives et améliorer votre efficacité.
