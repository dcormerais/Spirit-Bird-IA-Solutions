/*
  ...
  1. Modifications
    - Ajustement des horaires de 9h00 à 18h30
    - 19 créneaux de 30 minutes par jour
  ...
  IF EXTRACT(DOW FROM target_date) BETWEEN 1 AND 6 
    ...
    IF days_from_now >= 3 THEN
      ...
      FOR h IN 0..18 LOOP
        ...
        -- Tous les créneaux sont disponibles par défaut
...
-- Générer les créneaux pour les 90 prochains jours
DO $$
DECLARE
  date_cursor date := CURRENT_DATE;
