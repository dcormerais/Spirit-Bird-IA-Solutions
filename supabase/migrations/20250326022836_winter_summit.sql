/*
  ...
  1. Modifications
    ...
    - 1-2 créneaux indisponibles par jour la première semaine
*/
  ...
  IF EXTRACT(DOW FROM target_date) BETWEEN 1 AND 6 
    ...
    IF days_from_now >= 3 THEN
      ...
      FOR h IN 0..18 LOOP
        ...
        is_slot_available := NOT (h = ANY(unavailable_slots));
